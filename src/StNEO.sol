 ...
 * `_getTotalPooledEther` function. `Lido.sol` contract inherits StNEO and defines
 * the `_getTotalPooledEther` function.
 *
 * StNEO balances are dynamic and represent the holder's share in the total amount
 ...
 */
abstract contract StNEO is IERC20, Pausable {
    ...
    /**
     * @dev StNEO balances are dynamic and are calculated based on the accounts' shares
    ...
    */
     ...
     *
     * keccak256("lido.StNEO.totalShares")
     */
     ...
     * and corresponding StNEO amount.
     * The StNEO amount is calculated twice: before and after the burning incurred rebase.
     *
     * @param account holder of the burnt shares
     * @param preRebaseTokenAmount amount of StNEO the burnt shares corresponded to before the burn
     * @param postRebaseTokenAmount amount of StNEO the burnt shares corresponded to after the burn
     ...
     *
     * @dev The sum of all ETH balances in the protocol, equals to the total supply of StNEO.
     */
     ...
     */
    function _getTotalPooledEther() virtual internal view returns (uint256);
     ...
     * - `_recipient` cannot be the zero address or the `StNEO` token contract itself
    ...
    function _transferShares(address _sender, address _recipient, uint256 _sharesAmount) internal {
        ...
        require(_recipient != address(this), "TRANSFER_TO_StNEO_CONTRACT");
        _whenNotStopped();
